...
class RetrieveBISSValidatorFactorySpec extends UnitSpec {
  ...
  private def validator(nino: String, typeOfBusiness: String, taxYear: String, businessId: String) =
    validatorFactory.validator(nino, typeOfBusiness, taxYear, businessId)
  ...
  "validator" should {
    "return the parsed domain object" in {
      ...
      result shouldBe Right(
        RetrieveBISSRequestData(parsedNino, parsedTypeOfBusiness, parsedTaxYear, parsedBusinessId)
      )
    }
  }
