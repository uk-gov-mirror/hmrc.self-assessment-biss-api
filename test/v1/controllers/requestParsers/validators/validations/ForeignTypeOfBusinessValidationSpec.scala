  ...
  "validate" should {
    "return no errors" when {
      "a valid type of business is provided" in {
        ForeignTypeOfBusinessValidation.validate(typeOfBusiness) shouldBe Nil
      }
    }

    "return a type of business format error" when {
      "an invalid type of business is provided" in {
        ForeignTypeOfBusinessValidation.validate(badTypeOfBusiness) shouldBe List(TypeOfBusinessFormatError)
      }
    }
